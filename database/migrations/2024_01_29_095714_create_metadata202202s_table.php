...
return new class extends Migration
{
    ...
    {
        Schema::create('metadata202202s', function (Blueprint $table) {
            $table->id();
            $table->string('nama_indikator')->nullable();
            $table->string('konsep_indikator')->nullable();
            $table->string('definisi_indikator')->nullable();
            ...
            $table->string('definisi_variabel')->nullable();
    ...
    {
        Schema::dropIfExists('metadata202202s');
    }
};
